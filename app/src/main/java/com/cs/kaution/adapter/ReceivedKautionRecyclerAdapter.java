...
public class ReceivedKautionRecyclerAdapter extends FirestoreRecyclerAdapter<ReceivedKautionModel, ReceivedKautionRecyclerAdapter.KautionModelViewHolder> {
    Context context;
     ...
     * @param options
     */
    public ReceivedKautionRecyclerAdapter(@NonNull FirestoreRecyclerOptions<ReceivedKautionModel> options, Context c) {
        super(options);
        this.context = c;
    }
    ...
    @Override
    protected void onBindViewHolder(@NonNull KautionModelViewHolder holder, int position, @NonNull ReceivedKautionModel model) {
