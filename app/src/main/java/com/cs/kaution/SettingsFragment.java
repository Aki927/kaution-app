...
import com.cs.kaution.adapter.SettingsPagerAdapter;
...
/*
This Fragment nests the ProfileFragment and BugReportFragment.
 */
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tabLayout = view.findViewById(R.id.settings_navigation);
        viewPager = view.findViewById(R.id.viewpager);
        SettingsPagerAdapter adapter = new SettingsPagerAdapter(getChildFragmentManager(), 0);
